...
export default function Chatbot({ userType = 'admin' }: ChatbotProps) {
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-4 rounded-t-lg flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            {!isMinimized && (
              <p className="text-xs opacity-90">Your admin support assistant</p>
            )}
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
            {messages.length === 0 ? (
              <div className="text-center py-8">
                ...
                <h4 className="font-semibold text-gray-800 mb-2">Hi Admin! 👋</h4>
                <p className="text-gray-600 text-sm mb-4">
                  I'm here to help you manage the platform effectively.
                </p>
